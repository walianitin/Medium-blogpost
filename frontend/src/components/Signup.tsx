...
export default function SignUp() {
  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900   bg-gradient-to-b  from-#64748b via-#6b7280 to-#71717a">
    ...
    <div className="px-6 py-4">
        ...
        <form>
            <div className="w-full mt-4">
               ...
               <div className="w-full mt-4">
                <input className="block w-full px-4 py-2 mt-2 text-gray-200 placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="text" placeholder="Name" aria-label="Name" onChange={(e)=>setData({...data,name:e.target.value})} />
            </div>
    ...
    <div className="flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-gray-700">
        ...
        <a href="/signin" className="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:underline" >Signin</a>
    </div>
</div>
</div>
    </>
